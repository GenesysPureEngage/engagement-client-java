...
public class CreateCallbackParms {
  ...
  **/
  ...
  public CreateCallbackParms userData(Map<String, Object> userData) {
    this.userData = userData;
    return this;
  }

  public CreateCallbackParms putUserDataItem(String key, Object userDataItem) {
  ...
  **/
   ...
   * @return pushTargets
  **/
  @ApiModelProperty(value = "An array of push notification channels and targets that will receive a push notification. This is required when serviceName is configured to be USERORIGINATED, optional when it is USERTERMINATED.")
  ...
  public CreateCallbackParms alwaysCheckCapacity(Boolean alwaysCheckCapacity) {
    this.alwaysCheckCapacity = alwaysCheckCapacity;
    return this;
  }
   ...
   * @return alwaysCheckCapacity
  **/
  @ApiModelProperty(value = "Changes handling of capacity checks to prevent scheduled callbacks from being pushed into another time slot. Scheduled callbacks that are likely not to be handled by the capacity bucket specified by the desiredTime are rejected. This option also treats all callbacks with a desiredTime as a scheduled callback.")
  public Boolean isAlwaysCheckCapacity() {
    return alwaysCheckCapacity;
  }

  public void setAlwaysCheckCapacity(Boolean alwaysCheckCapacity) {
    this.alwaysCheckCapacity = alwaysCheckCapacity;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.serviceName, createCallbackParms.serviceName) &&
        ...
        Objects.equals(this.alwaysCheckCapacity, createCallbackParms.alwaysCheckCapacity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceName, phoneNumber, desiredTime, cbOfferType, language, inboundVQ, offerThreshold, channel, offerTiming, cbOriginationIxnId, surveyRP, priority, routePoint, userData, captchaToken, pushTargets, alwaysCheckCapacity);
  }
  ...
  public String toString() {
    ...
    sb.append("    alwaysCheckCapacity: ").append(toIndentedString(alwaysCheckCapacity)).append("\n");
    sb.append("}");
    return sb.toString();
  }
