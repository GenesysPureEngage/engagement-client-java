...
public class CreateCallbackParms {
  ...
  private String pushTarget = null;
  ...
  **/
  ...
  public CreateCallbackParms pushChannel(String pushChannel) {
   ...
   * @return pushChannel
  **/
  @ApiModelProperty(value = "The push channel to receive a push notification when the serviceName provided is configured to be USERORIGINATED. Otherwise this is ignored. Currently only supports a value of 'FCM'.")
  ...
  public CreateCallbackParms pushTarget(String pushTarget) {
   ...
   * @return pushTarget
  **/
  @ApiModelProperty(value = "The push target to receive a push notification when the serviceName provided is configured to be USERORIGINATED. Otherwise this is ignored.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.serviceName, createCallbackParms.serviceName) &&
        ...
        Objects.equals(this.pushChannel, createCallbackParms.pushChannel) &&
        Objects.equals(this.pushTarget, createCallbackParms.pushTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceName, phoneNumber, desiredTime, cbOfferType, language, inboundVQ, offerThreshold, channel, offerTiming, cbOriginationIxnId, surveyRP, priority, routePoint, userData, captchaToken, pushChannel, pushTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("    pushChannel: ").append(toIndentedString(pushChannel)).append("\n");
    sb.append("    pushTarget: ").append(toIndentedString(pushTarget)).append("\n");
    sb.append("}");
    return sb.toString();
  }
